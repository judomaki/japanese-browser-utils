      ...
      //don't do anything if text is same as previous
       if(previousRomaji != romaji) {
          ...
          //double-letter sillables
              ...
              .replace(/zā/g,"ざあ").replace(/z|ī/g,"じい").replace(/zū/g,"ずう").replace(/z|ē/g,"ぜい").replace(/zō/g,"ぞう")
              ...
              .replace(/za/g,"ざ").replace(/z|i/g,"じ").replace(/zu/g,"ず").replace(/z|e/g,"ぜ").replace(/zo/g,"ぞ")
